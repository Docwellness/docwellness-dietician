...
class RecipeTranslation {
  ...
  // Positionally aligned with RecipePreview.components (the PORTIONS
  // SUMMARY chips) - only the label is translated server-side, quantity/
  // unit stay as-authored. May be empty/shorter than components on older
  // recipes generated before this existed; callers fall back to matching
  // a component's label against `ingredients` by name in that case (see
  // recipe_details.dart's _componentLabel).

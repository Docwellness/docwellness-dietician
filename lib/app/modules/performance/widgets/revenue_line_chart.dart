          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xffDFFFE4),
                  border: Border.all(color: const Color(0xff9EFFB2)),
